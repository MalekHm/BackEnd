...
public class EmailService {
    ...
    public String sendResponseHoliday(String to, String start, String end) {
        ...
        try {
            ...
            mailMessage.setFrom("yhmmalek@gmail.com");
    ...
    public String sendToken(String to, String token ) {
        ...
        try {
            ...
            mailMessage.setText("http://localhost:4200/resetPassword/"+token);

...
public class TrainingRequestServiceI implements TrainingRequestService {
    ...
    public List<TrainingRequest> getListByUser(Long id) {
        return trainingRequetsRepository.findMyTraining(id);
    }
    ...
    public TrainingRequest confirmed(Long id) {
        ...
        trainingRequest.get().setStatus("Confirmed");
    ...
    @Override
    public List<TrainingRequest> getListRequest(Long id) {
        return trainingRequetsRepository.findByUser(id);
    }
}

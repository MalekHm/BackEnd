...
public class RemoteController {
    ...
    public   ResponseEntity<Remote> confirmed(@PathVariable(value = "id") Long id, @PathVariable(value = "newStatus") String newStatus) {
        Remote remote= remoteService.confirmed(id,newStatus);

...
public class PermissionController {
    ...
    public   ResponseEntity<Permission> confirmed(@PathVariable(value = "id") Long id,@PathVariable(value = "newStatus") String newStatus) {
        Permission permission= permissionService.confirmed(id,newStatus);
